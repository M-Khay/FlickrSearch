...
import com.yourself.flickrsearch.utils.Constant.IMAGES_PER_PAGE
...
class ImageSearchRepositoryImpl(private val imageSearchApi: ImageSearchApi) :
    ...
    override suspend fun getImageListWith(searchTerm: String, pageNumber: Int): ApiResponse =
        imageSearchApi.getImageListFor(METHOD, API_KEY, IMAGES_PER_PAGE, NO_JSON_CALLBACK,  FORMAT,pageNumber, searchTerm)
